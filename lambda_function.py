...
def launch_request_handler(request):
    return alexa.create_response(message="Hello Sajal. I am ready to response to Hi.")


@alexa.request_handler("SessionEndedRequest")
def session_ended_request_handler(request):
    return alexa.create_response(message="Bye bye Sajal!")
...
def get_recipe_intent_handler(request):
    ...
    if name != "john":
        return alexa.create_response("This is not my name. My name is John")
    ...
    return alexa.create_response("Hello sajal nice to meet you.")
